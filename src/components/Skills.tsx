...
const skills = [
  ...
  { name: "TypeScript", pct: 55, color: "#c8860a", level: "習得中" },
  { name: "React / Next.js", pct: 48, color: "#c8860a", level: "習得中" },
  { name: "Python", pct: 50, color: "#c8860a", level: "習得中" },
  { name: "AI活用 (Claude Code)", pct: 75, color: "#2d8f4e", level: "実践中" },
];
        ...
        <FadeIn>
          <div style={{ marginTop: 48, padding: "20px 24px", border: "1px solid #ddd", borderLeft: "3px solid var(--accent)", borderRadius: 2, maxWidth: 600, background: "#fff" }}>
            ...
            <div className="font-serif-jp" style={{ fontSize: 12, color: "var(--text-light)", lineHeight: 1.8 }}>
              モダン技術は現在も積極的に習得中です。40年の経験とAIを組み合わせ、レガシーとモダンの橋渡しができることが私の強みです。
            </div>
          </div>
        </FadeIn>
      </div>
