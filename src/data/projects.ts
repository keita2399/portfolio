...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "世界の美術館・博物館のコレクションをスマホで気軽に楽しめるFlutter Webアプリシリーズ。Three.jsによる3Dオランジュリー美術館、GPUシェーダーによるスポットライト演出、毎日1作品との出会い（ガチャ）、作品クイズなど、アート体験をデジタルで再現。LINEボットが毎朝おすすめ作品を届ける。美術館さんぽ・画家さんぽ・特集さんぽの3カテゴリで7アプリを展開中。",
    ...
    detail: {
      ...
      results: [
        "美術館さんぽ3種（メトロポリタン・クリーブランド・スミソニアン）、画家さんぽ3種（フェルメール・レンブラント・モネ）、特集さんぽ1種（印象派）の計7アプリを公開",
